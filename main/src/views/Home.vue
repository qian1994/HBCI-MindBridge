    ...
    <div class="app-window">
      ...
      <div class="app-window-content">
        <div>
          ...
          <p>
            HBCI团队创建于2019年8月，以潘家辉教授为召集人，现有梁艳、邱丽娜、王斐、李景聪、周成菊、罗胜周、曲超、何乐为、黄海云等10位研究生导师，2位在读博士后，60位硕士研究生，以及多个本科生研究小组。团队主要围绕着脑机接口和计算机视觉领域，研究新一代人机交互和人机混合智能的关键核心技术。具体研究方向包括：面向意识障碍和运动障碍的多模态脑机接口技术、基于人脸表情和脑电信号的情绪识别、睡眠脑电的实时监测与调控、步态识别和健康评估、医学图像处理、以及混合智能的人机交互技术等。
            脑机接口（brain-computer interface, BCI），是在人脑与计算机或其它电子设备之间建立的直接的交流和控制通道 。通过这种通道 ,人就可以直接通过脑来表达想法或操纵设备 ,而不需要语言或动作。脑机接口技术被誉为人脑与外界沟通交流的“信息高速公路”，是公认的新一代人机交互和人机混合智能的关键核心技术，被美国商务部列为14项出口管制技术之一。
            山不辞土，故能成其高；海不辞水，故能成其深。欢迎有志于脑机交互与混合智能技术的同学选择和报考我们团队
          </p>
          <div>
            <img src="" alt="">
          </div>
      ...
      <div class="app-contact">
        <div>
          ...
          <p>网址：https://www.scholat.com/showTeamworkBrief.html?id=1158&changeTo=Ch&nav=1</p>
        </div>
      </div>
    </div>
  </div>
