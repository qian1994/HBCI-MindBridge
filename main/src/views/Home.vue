    ...
    <div class="app-window">
      ...
      <div class="app-window-content">
        <div>
          ...
          <p>
            视动脑科技团队是以华南师范大学陈娟教授为首的脑科学研究团队。陈娟教授入选国家重要海外人才引进计划青年项目，专注于视觉与动作方面的研究。团队专业采用心理物理学，眼球追踪，运动追踪，脑电图，磁共振成像，神经干预，深度学习及计算建模的方法，从事大脑视觉和动作方面的科学研究，功能评估和康复训练系统的开发、建设及应用，致力于为健康人群的视觉与动作系统功能增强，以及病人的临床神经疾病诊断、治疗与康复提供专业指导
          </p>
          <div>
            <img src="" alt="">
          </div>
